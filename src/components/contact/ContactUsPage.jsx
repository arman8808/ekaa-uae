        ...
        <div className="max-w-4xl mx-auto">
          ...
          >
            ...
            <div className="space-y-8">
              {/* Google Map */}
              <motion.div
                variants={ANIMATION_CONFIG.fadeInRight}
                className="bg-white/80 backdrop-blur-sm rounded-2xl shadow-xl overflow-hidden"
              >
                <div className="p-6 border-b border-gray-200">
                  <h3 className="text-xl font-semibold text-[#6E2D79] font-poppins">
                    Visit Our Location
                  </h3>
                  <p className="text-gray-600 mt-2">
                    EKAA TECHNICAL SKILLS TRAINING LLC
                  </p>
                </div>
                <div className="relative w-full h-80 sm:h-96 lg:h-64 xl:h-80">
                  <iframe
                    src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3451.780846599431!2d54.3813021!3d24.469423900000002!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3e5e67ccc3609d95%3A0xa8a7d6890f72a1cd!2sEKAA%20TECHNICAL%20SKILLS%20TRAINING%20LLC!5e1!3m2!1sen!2sin!4v1759859508992!5m2!1sen!2sin"
                    width="100%"
                    height="100%"
                    style={{ border: 0 }}
                    allowFullScreen=""
            ...
            >
              <h3 className="text-xl font-semibold text-[#6E2D79] font-poppins mb-4">
                Contact Information
              </h3>
              <div className="space-y-4">
                <div className="flex items-start space-x-3">
                  <div className="w-8 h-8 rounded-full bg-[#6E2D79] flex items-center justify-center flex-shrink-0">
                    <svg
