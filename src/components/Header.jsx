    ...
    >
      <div className="w-full mx-auto h-full flex items-center justify-between px-4 md:px-8 py-2">
        ...
        <div className="flex items-center space-x-2 md:space-x-4 lg:space-x-6">
          <button
            ...
            className="gold-border-btn cursor-pointer hidden md:inline-flex items-center justify-center gap-[10px] px-[14px] py-[10px] lg:py-[12px]  rounded-full text-[#6E2D79] text-base lg:text-[18px] leading-tight lg:leading-[33px] font-medium font-[Poppins] bg-white transition whitespace-nowrap"
          >
            Schedule
          </button>
      ...
      >
        ...
        <div className="px-6 py-2">
          <button
            onClick={() => negivate("/practitioner")}
            className="gold-border-btn inline-flex items-center justify-center gap-[10px] px-[14px] py-[10px] border border-[#6E2D79] rounded-full text-[#6E2D79] text-lg font-medium font-[Poppins] bg-white transition"
          >
            Schedule
          </button>
        </div>
