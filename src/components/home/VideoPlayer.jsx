...
const VideoPlayer = ({
  ...
  return (
    <div className="relative w-full max-w-7xl mx-auto rounded-lg overflow-hidden py-10 sm:py-14 md:py-20 px-4 sm:px-6 lg:px-8">
      <h2 className="text-center text-[32px] sm:text-[36px] md:text-[42px] lg:text-[64px] xl:text-[64px] font-medium  font-poppins mb-10 sm:mb-8 lg:mb-8 leading-tight text-[#6e2d79]">HHME</h2>
      {/* <div className="hidden lg:block absolute top-19 left-1/2 -translate-x-1/2 sm:top-20 sm:left-1/2 md:top-70 md:left-100 lg:top-180 lg:left-1/2 z-[999] pointer-events-none">
        <img src="/2.2.svg" alt="Leaf" />
      </div> */}
      ...
      <div
        ...
        className={`relative aspect-video rounded-2xl overflow-hidden ${
          isFullscreen
            ? "bg-black w-screen h-screen aspect-auto fixed top-0 left-0 z-[9999] rounded-none flex items-center justify-center"
            : ""
        }`}
      >
        {/* Thumbnail Overlay */}
        ...
        {videoStarted && !showThumbnail && showControls && (
          <div
            className={`absolute left-1/2 -translate-x-1/2 z-[1000] flex flex-col items-center px-2 sm:px-0 ${
              isFullscreen
                ? "bottom-8 sm:bottom-12 lg:bottom-1"
                : "bottom-1 sm:bottom-4 lg:bottom-1 "
            }`}
          >
            <div
              className={`flex flex-col bg-[#6E2D79] rounded-full px-2.5 py-1.5 sm:px-3 sm:py-2 lg:px-4 lg:py-2 w-full max-w-sm sm:max-w-lg lg:w-[622px] lg:h-[51px] ${
              ...
              style={{
                width: isFullscreen
                  ? "min(calc(100vw - 64px), 800px)"
                  : "min(calc(100vw - 32px), 622px)",
                flexShrink: 0,
              }}
            >
              {/* Progress Bar on Top */}
              ...
              <div className="relative flex items-center justify-between w-full py-0.5 sm:py-1 lg:py-0">
                ...
                <div className="flex items-center space-x-1.5 sm:space-x-2 lg:space-x-4">
                  ...
                  <span
                    className={`hidden sm:inline text-white font-mono select-none ${
                      isFullscreen ? "text-sm lg:text-base" : "text-xs"
                    }`}
                  >
                    {videoRef.current
                ...
                <div className="flex items-center space-x-1.5 sm:space-x-2 lg:space-x-3">
                  {/* Time display for mobile only */}
                  <span
                    className={`sm:hidden text-white font-mono select-none ${
