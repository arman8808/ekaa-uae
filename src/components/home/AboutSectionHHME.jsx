  ...
  return (
    <div className="bg-white py-16 px-4 sm:px-6 lg:px-8">
      <div className="max-w-6xl mx-auto">
        ...
        {/* Paragraph */}
        <p
          className="text-lg sm:text-xl leading-relaxed text-center max-w-4xl mx-auto mb-12"
          style={{ color: "#A35F93" }}
        >
          EKAA is honoured to be the Headline Sponsor of HHME 2025 – a unique
          international platform celebrating the convergence of science,
          metaphysics, and integrative wellness. Our participation underscores
          our mission to bridge traditional wisdom with modern science, and to
          lead the evolution of emotional and mental well-being globally.
        </p>
