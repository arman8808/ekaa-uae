...
import { Eye, Download, RefreshCw, AlertCircle, Search, Filter, X, ZoomIn, LogOut } from 'lucide-react';
    ...
    <div className="w-full max-w-7xl mx-auto p-4 space-y-6">
      ...
      <div className="bg-white rounded-lg shadow-lg p-6">
        <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between space-y-4 lg:space-y-0">
          <div>
            <h1 className="text-2xl lg:text-3xl font-bold text-[#6E2D79]">Awaken Limitless Human - Admin Dashboard</h1>
                ...
                <div className="lg:col-span-2 space-y-6">
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div className="space-y-4">
                      ...
                      <div className="space-y-2">
                        <p><span className="font-medium">Level:</span> {selectedRegistration.levelName || 'N/A'}</p>
                        <p><span className="font-medium">Date:</span> {formatDate(selectedRegistration.courseDetailDate)}</p>
                        <p><span className="font-medium">Venue:</span> {selectedRegistration.courseDetailVenue || 'N/A'}</p>
                        <p><span className="font-medium">Time Slot:</span> {selectedRegistration.timeslot || 'N/A'}</p>
                      </div>
                    </div>
