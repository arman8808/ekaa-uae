...
const TassoRegistrations = () => {
  ...
  const fetchRegistrations = async (page = 1) => {
    ...
    try {
      ...
      const response = await tassoRegistrationService.getRegistrations(
        pagination,
        filters
      );
  ...
  const exportToCSV = async (startDate, endDate) => {
    ...
    try {
      ...
      }tasso-registration/download?${params.toString()}`;
...
export default TassoRegistrations;
